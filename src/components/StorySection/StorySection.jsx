    ...
    <section className="story-section">
      <div className="story-content">
        ...
        <div className="story-text">
          ...
          <p>
            Mattéo (le créatif) et Tom (l&apos;ingénieur) ont uni leurs forces
            pour offrir le meilleur des deux mondes. Pourquoi 19.21 ? C&apos;est
            un clin d&apos;œil à nos jours de naissance respectifs. Ce nom
            scelle notre complémentarité : derrière chaque projet, il y a deux
            passionnés qui s&apos;investissent personnellement.
          </p>
          <p>
